        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <table class="auto-style1">
                        <tr>
                            <td class="auto-style2">
                                <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="MaBaiBao" DataSourceID="dsThemBao" OnPageIndexChanging="FormView1_PageIndexChanging1" Style="margin-right: 0px" Width="100%">
                                    <EditItemTemplate>
                                        <table class="auto-style1">
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <br />
                                                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="dsEditCategory" DataTextField="TenTheLoai" DataValueField="MaTheLoai">
                                                    </asp:DropDownList>
                                                    <asp:SqlDataSource ID="dsEditCategory" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [TheLoai]"></asp:SqlDataSource>
                                                </td>
                                                <td>
                                    ...
                                    <ItemTemplate>
                                        <table class="auto-style1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="imvEdit" runat="server" ImageUrl='<%# Eval("Image","~/public/image/{0}") %>' Width="150px" />
                                                    <br />
                                            ...
                                            <tr>
                                                <td class="auto-style3">Ngày đăng<br />
                                                </td>
                                                <td>
                    ...
                    <asp:Image ID="imgUp" runat="server" Width="150px" /><br />
                                <asp:TextBox ID="idTxtLinkImageUpdate" runat="server"></asp:TextBox><br />
                                <asp:FileUpload ID="FileUploadBao" runat="server" />
                                <asp:Button ID="btnUploadBao" runat="server" OnClick="UploadBao" Text="Upload" />
